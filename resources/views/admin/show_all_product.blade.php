                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ url('/TrashProduct') }}"><button
                                    class="btn btn-danger d-inline-block m-2 float-right"> Go to trash</button></a>
                                    ...
                                    <tbody>
                                        @foreach ($product as $row)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('update.product', $row->id) }}"><button
                                                            class="btn btn-primary">Update</button></a></td>
                                                <td><a onclick="return confirm('Are You Sure You Want To Delete This Product')"
                                                        href="{{ route('delete.product', $row->id) }}"><button
                                                            class="btn btn-danger">Trash</button></a> </td>
                                            </tr>
                                        @endforeach
